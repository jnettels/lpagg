...
With the correct settings you can get the settings of 
[demandlib](https://github.com/oemof/demandlib/tree/features/add-vdi-from-lpagg). 
With the configuration setting use_demandlib=true yo may choose to let the
VDI 4655 profiles be generated by demandlib. See the following tabel for the 
created profiles and sources.

|                  |                    | lpagg             | lpagg + demandlib    |
| ---------------- | ------------------ | ----------------- | -------------------- |
| HH (households)  | Heating            | VDI 4655 (lapgg)  | VDI 4655 (demandlib) |
|                  | Domestic hot water | VDI 4655 (lapgg)  | VDI 4655 (demandlib) |
|                  | Electricity        | VDI 4655 (lapgg)  | VDI 4655 (demandlib) |
| GHD (commercial) | Heating            | futuresolar       | futuresolar          |
|                  | Domstic hot water  | DOE               | DOE                  |
